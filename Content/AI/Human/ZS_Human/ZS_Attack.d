...
func int ZS_Attack_Loop ()
{
	...
	if (self.id == 115) && (KurganMozeStop == TRUE) && (KurganAtakuje == FALSE)
	{
		B_ClearPerceptions (self);
		Npc_ClearAIQueue(self);
		AI_StandUpQuick(self);
	...
	if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(NASZ_429_WojownikCienia)) && (WojownikCieniaMozeWalczyc == FALSE)
