...
const int	Value_SheepFur				=	5;
const int	Value_WolfFur				=	5;
const int	Value_BugMandibles			=	15;	
const int	Value_Claw					=	5;
const int	Value_LurkerClaw			=	5;	
const int	Value_Teeth					=	5;
const int	Value_CrawlerMandibles		=	15;	
const int	Value_Wing					=	10;
const int	Value_Sting					=	10;
const int	Value_ReptileSkin			=	10;
const int 	Value_WargFur				=	15;
const int	Value_DrgSnapperHorn		=	50;
const int	Value_CrawlerPlate			=	20;
const int	Value_ShadowFur				=	70;
const int	Value_SharkSkin				=	50;
const int	Value_TrollFur				=	150;
const int	Value_WaranFiretongue		=	100;
const int	Value_ShadowHorn			=	50;
const int	Value_SharkTeeth			=	50;
const int	Value_TrollTooth			=	100;
...
const int	Value_IceGolemHeart			=	200;
...
INSTANCE ItAt_CrawlerMandibles (C_Item)
{
	...
	TEXT[2]				= 	"która pozwala zregenerowaæ si³y.";
