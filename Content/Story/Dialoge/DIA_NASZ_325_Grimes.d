...
FUNC VOID DIA_NASZ_325_Grimes_cave_ucieczka()
{
	...
	AI_Output (other, self,"DIA_NASZ_325_Grimes_cave_ucieczka_55_01"); //Wkrótce potem, z niewielk¹ pomoc¹, wróci³em do kopalni i zabi³em Marcosa. 
...
FUNC VOID DIA_NASZ_325_Grimes_cave_end()
{
	...
	AI_Output (other,self ,"DIA_NASZ_325_Grimes_cave_end_15_02"); //Tak. Na razie pobêdziesz chwilê tam. Nie bój siê, bêdê ciê tam chroni³.
...
FUNC VOID DIA_NASZ_325_Grimes_AfterAll_Info()
{
	if (KAPITEL < 3) {
		...
		AI_Output (self, other,"DIA_NASZ_325_Grimes_AfterAll_15_05"); //Najwa¿niejsze, ¿e wszystko siê uda³o, przyjacielu. Pamiêtaj o tym.
	};
