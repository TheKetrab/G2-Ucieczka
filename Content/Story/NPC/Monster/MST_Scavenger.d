...
func void B_SetVisuals_Scavenger3()
{
	Mdl_SetVisual			(self,	"Scavenger.mds");
	//								Body-Mesh		Body-Tex	Skin-Color	Head-MMS	Head-Tex	Teeth-Tex	ARMOR
	Mdl_SetVisualBody		(self,	"Sca_Body3",		DEFAULT,	DEFAULT,	"",			DEFAULT,  	DEFAULT,	-1);
};
...
INSTANCE GroznyScierwojad	(Mst_Default_Scavenger)
{
	Npc_SetToFistMode(self);
	B_SetVisuals_Scavenger2();
	CreateInvItems (self, ItFoMuttonRaw, 1);
	
	name							=	"Groüny úcierwojad";
	level							=	14;
...
INSTANCE QuestWrzodScavenger	(Mst_Default_Scavenger)
{
	Npc_SetToFistMode(self);
	B_SetVisuals_Scavenger();
	CreateInvItems (self, ItFoMuttonRaw, 1);
	guild = GIL_FRIENDLY_ORC;
	name							=	"Oswojony úcierwojad";
};

INSTANCE MlodyScierwojad	(Mst_Default_Scavenger)
{
	Npc_SetToFistMode(self);
	B_SetVisuals_Scavenger3();
	CreateInvItems (self, ItFoMuttonRaw, 1);
	guild = GIL_FRIENDLY_ORC;
	name							=	"M≥ody úcierwojad";
};
