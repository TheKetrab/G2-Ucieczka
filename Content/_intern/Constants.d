...
var int Hero_UseGolemHeart;
var int AmountOfUseIceCubeHeart_1;

////////constants.d (na pocz¹tku pliku) //////////
var int level_zielarstwa;
var int level_regeneracji;
const int HP_lvl_1 = 1;
const int HP_lvl_2 = 3;
const int HP_lvl_3 = 5;
// mo¿na zrobiæ jeszcze wiêcej levelów;) ///////
...
const int SPL_Oswojenie				= 64;	// nasz
const int SPL_CreatePortal		    = 65;	// nasz
const int SPL_GotoPortal	        = 66;	// nasz
const int SPL_CreatePortal2	        = 67;	// nasz
const int SPL_GotoPortal2			= 68;	// nasz
const int SPL_Grow					= 69;	// nasz
...
const int SPL_TeleportRockcamp		= 77;
const int SPL_TeleportBagno			= 78;
...
// ...
const int SPL_TeleportMysliwi		= 90;
const int SPL_TeleportLowcy			= 91;
const int SPL_TeleportBandyci		= 92;
const int SPL_SummonKurgan			= 93;
const int SPL_TeleportOzywieniec	= 94;
const int SPL_TeleportAlchemicy		= 95;
const int SPL_TeleportTwierdza		= 96;
const int SPL_TeleportPrzelecz		= 97;
const int SPL_GroupHeal				= 98;
const int SPL_SummonStraznik		= 99;
const int SPL_TeleportOrcTown		= 100;
...
const string spellFxInstanceNames[MAX_SPELL] =
{
	...
	"Charm",  				// 64	SPL_Oswojenie
	"Teleport",  			// 65	SPL_CreatePortal
	"Teleport",  			// 66	SPL_GotoPortal
	"Teleport",				// 67	SPL_CreatePortal2
	"Teleport",				// 68	SPL_GotoPortal2
	"Teleport",				// 69	SPL_Grow
	...
	"Teleport",				// 77	SPL_TeleportRockcamp
	"Teleport",				// 78	SPL_TeleportBagno
	...
	"Teleport",				// 97	SPL_TeleportPrzelecz
	"Heal",  				// 98	SPL_GroupHeal
	"Teleport",			// 99	SPL_SummonStraznik
	"Teleport"				// 100	SPL_TeleportOrcTown
};
...
const string spellFxAniLetters[MAX_SPELL] =
{
	...
	"FIB",  				// 64	SPL_Oswojenie
	"HEA",  				// 65	SPL_CreatePortal
	"HEA",  				// 66	SPL_GotoPortal
	"HEA",					// 67	SPL_CreatePortal2
 	"HEA",					// 68	SPL_GotoPortal2
	"HEA",					// 69	SPL_Grow
	...
	"HEA",					// 77	SPL_TeleportRockcamp
	"HEA",					// 78	SPL_TeleportBagno
	...
	// ...
	"HEA",  				// 90	SPL_TeleportMysliwi
	"HEA",  				// 91	SPL_TeleportLowcy
	"HEA",  				// 92	SPL_TeleportBandyci
	"FEA",  				// 93	SPL_KurganDuch
	"HEA",  				// 94	SPL_TeleportOzywieniec
	"HEA",  				// 95	SPL_TeleportAlchemicy
	"HEA",  				// 96	SPL_TeleportTwierdza
	"HEA",					// 97	SPL_TeleportPrzelecz
	"HEA",					// 98	SPL_GroupHeal
	"HEA",					// 99	SPL_SummonStraznik
	"HEA"				// 100	SPL_TeleportOrcTown
};
...
// ******* MunitionSystem *******
var int MunitionName;
var int MunitionDMG;

var int BowMunition;
const int NormalArrow = 0;
