...
func void B_BeliarsWeaponSpecialDamage (var C_NPC oth, var C_NPC slf) //other ist angreifer, slf ist victim
{
	...
	if (Hlp_GetInstanceID(oth) == Hlp_GetInstanceID(hero))
	{
		...
		mocMieczRuniczny = mocMieczRuniczny - 1;
			...
			if (mocMieczRuniczny == 0) { PrintScreen ("Kryształ w mieczu stracił swoją moc", -1,-1, "font_old_20_white.tga",2); }
			else if (mocMieczRuniczny == 5) { PrintScreen ("Kryształ w mieczu traci blask...", -1,-1, "font_old_20_white.tga",2); }; 
