...
CONST STRING MOBNAME_FORGE			= "Palenisko";				//Schmiede
...
CONST STRING MOBNAME_SAW			= "Drewno";			//Sägemobsi
...
CONST STRING MOBNAME_GRAVE_09	 = "Nieznany";
...
CONST STRING MOBNAME_MISSION_ZGNILIZNA	 = "Nadgni³a deska"; 			//nasz
CONST STRING MOBNAME_MISSION_BRYSON		 = "Bry³a nadkruszonej rudy"; 		//nasz
CONST STRING MOBNAME_MISSION_LOUIS		 = "Kufer Louisa"; 				//nasz
CONST STRING MOBNAME_MISSION_BRON	 	 = "Skrzynia Brona"; 			//nasz
CONST STRING MOBNAME_STOLDESTYLACYJNY	 = "Stó³ destylacyjny"; 		//nasz
CONST STRING MOBNAME_ORE_COAL			 = "Z³o¿e wêgla";				//nasz
CONST STRING MOBNAME_ORE_CRYSTAL	 	 = "Kryszta³";					//nasz
...
CONST STRING MOBNAME_MISSION_GRAVE6	 = "Ukit"; 										//nasz
CONST STRING MOBNAME_MISSION_GRAVE7	 = "Blem"; 										//nasz
CONST STRING MOBNAME_MISSION_GRAVE8	 = "Thora - Jej historia niby poczêta, a nigdy nie skoñczona."; 				//nasz
CONST STRING MOBNAME_MISSION_GRAVE9	 = "Susan Piêkna"; 								//nasz
CONST STRING MOBNAME_MISSION_GRAVE10 = "Laplace - Matematyk"; 						//nasz
CONST STRING MOBNAME_MISSION_GRAVE11 = "Thorin - 'Pamiêtaj o jab³kach!'"; 			//nasz
CONST STRING MOBNAME_MISSION_GRAVE12 = "Kurokuma - NiedŸwiedŸ"; 					//nasz
CONST STRING MOBNAME_MISSION_GRAVE13 = "Olimpacos - 'Po dwakroæ kochany'"; 			//nasz
CONST STRING MOBNAME_MISSION_GRAVE14 = "Pradziad wilków"; 							//nasz
CONST STRING MOBNAME_MISSION_GRAVE15 = "Ketty Dun - 'W mojej pamiêci'"; 			//nasz
CONST STRING MOBNAME_MISSION_GRAVE16 = "Gravitatius - 'Wróci³ na tarczy'"; 			//nasz
CONST STRING MOBNAME_MISSION_GRAVE17 = "Melatonix - 'Postrach najm¹drzejszych'"; 	//nasz
...
CONST STRING MOBNAME_TARCZASTRZELECKA = "Tarcza strzelecka"; //nasz
...
const string TXT_SPELLS[MAX_SPELL] =
{
	...
	// Scrolls
	"Bagienny truteñ",			// 47	SPL_TrfSheep
	"Œcierwojad",				// 48	SPL_TrfScavenger
	"Kamienny golem",			// 49	SPL_TrfGiantRat
	"Chrz¹szcz",				// 50	SPL_TrfGiantBug
	"Wilk",						// 51	SPL_TrfWolf
	...
	"Oswojenie",				// 64	SPL_Oswojenie
	"Stwórz portal 1",			// 65	SPL_CreatePortal
	"Przenieœ do portalu 1",	// 66	SPL_GotoPortal
	"Stwórz portal 2",			// 67	SPL_CreatePortal2
  	"Przenieœ do portalu 2",	// 68	SPL_GotoPortal2
  	"Powiêkszenie",				// 69	SPL_Grow
	...
	"Na po³udniowy-wschód",		// 77	SPL_TeleportRockcamp
	"Na bagno",		// 78	SPL_TeleportBagno
	...
	// ...
	"Do obozu myœliwych",		// 90	SPL_TeleportMysliwi
...
const string NAME_SPL_Reserved_65			= "Stwórz portal 1";
const string NAME_SPL_Reserved_66			= "Przenieœ do portalu 1";
const string NAME_SPL_Reserved_67			= "Stwórz portal 2";
const string NAME_SPL_Reserved_68			= "Przenieœ do portalu 2";
const string NAME_SPL_Reserved_69			= "Powiêkszenie";
...
CONST STRING TXT_TALENTS [NPC_TALENT_MAX] =
{
	...
	"Fach z³odziejski",	//altes	Pickpocket aus Gothic 1	- NICHT	benutzen! Bleibt als Relikt	im Code	= 6;
	"Magia",					//NPC_TALENT_MAGE				= 7;	// Magiekreis
	"Skradanie siê",			//NPC_TALENT_SNEAK				= 8;
	"Regeneracja",					//raus //NPC_TALENT_REGENERATE	= 9;
	"Walka tarcz¹",					//raus //NPC_TALENT_FIREMASTER	= 10;
	...
	"Górnictwo",				//NPC_TALENT_C					= 19;
	"Szybka nauka",				//NPC_TALENT_D					= 20;
	"Zielarstwo"				//NPC_TALENT_E					= 21;
};
...
const string NAME_Teleport			= "Runa teleportacyjna"; // nasz
...
// ***************************************************************************************
const string Pickpocket_20	=	"(Kradzie¿ bêdzie dziecinnie ³atwa.)";
const string Pickpocket_40	=	"(Kradzie¿ bêdzie doœæ prosta.)";
const string Pickpocket_60	=	"(Kradzie¿ bêdzie doœæ ryzykowna.)";
const string Pickpocket_80	=	"(Kradzie¿ bêdzie trudna.)";
const string Pickpocket_100	=	"(Kradzie¿ bêdzie diabelsko trudna.)";
const string Pickpocket_120	=	"(Kradzie¿ bêdzie graniczy³a z cudem.)";
...
const string KapWechsel_1_Text		= "Zmiany"					;
const string KapWechsel_2			= "Rozdzia³ 2"					;
const string KapWechsel_2_Text		= "Nowe zagro¿enie"			;
const string KapWechsel_3			= "Rozdzia³ 3"					;
const string KapWechsel_3_Text		= "Polowanie na orków"					;
...
const string NAME_Range = "Zasiêg broni:";
