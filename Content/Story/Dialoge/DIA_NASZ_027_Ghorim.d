...
func void DIA_NASZ_027_Ghorim_Lojalnosc_Info ()
{
	...
	AI_Output			(self, other, "DIA_NASZ_027_Ghorim_Lojalnosc_027_00"); //Stój tam, gdzie stoisz! Inaczej podeptasz bagienne ziele, które muszê ugnie¶æ i zanie¶æ Cor Kalomowi!
	...
	AI_Output			(other, self, "DIA_NASZ_027_Ghorim_Lojalnosc_15_03"); //Spokojnie, Ghorimie. My¶lê, ¿e móg³by¶ wzi±æ sobie przerwê i odpocz±æ nieco od pracy. Ka¿demu przecie¿ nale¿y siê wypoczynek i wytchnienie.
	AI_Output			(other, self, "DIA_NASZ_027_Ghorim_Lojalnosc_15_04"); //Pamiêtam, ¿e swego czasu du¿o odpoczywa³e¶.
	...
	AI_Output			(self, other, "DIA_NASZ_027_Ghorim_Lojalnosc_027_06"); //Ale masz racjê: Nale¿y mi siê wypoczynek. A skoro ju¿ tu jeste¶, to mo¿e móg³by¶ mi pomóc?
	AI_Output			(other, self, "DIA_NASZ_027_Ghorim_Lojalnosc_15_07"); //Oczywi¶cie, duchu. Czego potrzebujesz?
	AI_Output			(self, other, "DIA_NASZ_027_Ghorim_Lojalnosc_027_08"); //Wiesz, ¿ycie w tym miejscu jest naprawdê smutne i pozbawione rado¶ci z ¿ycia, a naprawdê chcia³bym siê trochê rozerwaæ.
	AI_Output			(self, other, "DIA_NASZ_027_Ghorim_Lojalnosc_027_09"); //Mo¿e móg³by¶ przynie¶æ mi jak±¶ ksi±¿kê do poczytania? S³owo pisane od zawsze potrafi³o mnie rozweseliæ.
	...
	AI_Output			(self, other, "DIA_NASZ_027_Ghorim_Lojalnosc_027_12"); //Ju¿ kilkukrotnie przeszukiwa³em jego chatê. Lukor musia³ wzi±æ tê ksiêgê ze sob±, gdy wybra³ siê na cmentarzysko orków. Jestem przekonany, ¿e to w³a¶nie w niej zapisa³ co¶ o swoich objawieniach. 
...
func void DIA_NASZ_027_Ghorim_Ksiazka_Info ()
{
	...
	AI_Output			(self, other, "DIA_NASZ_027_Ghorim_Ksiazka_027_02"); //Naprawdê mi j± przynios³e¶? Mo¿e ¶miertelnicy nie s± tacy bezduszni na jakich ich siê kreuje. Proszê, przyjmij ode mnie w nagrodê mój pier¶cieñ.
	AI_Output			(self, other, "DIA_NASZ_027_Ghorim_Ksiazka_027_03"); //Mi siê ju¿ nie przyda, a tobie z pewno¶ci± pomo¿e podczas dalszych wêdrówek. Powiniene¶ znale¼æ go w mojej chacie o ile ta jeszcze istnieje, je¿eli go tam nie bêdzie poszukaj w okolicy.
	AI_Output			(other, self, "DIA_NASZ_027_Ghorim_Ksiazka_15_04"); //Dziêkuje Ghorimie, na pewno mi siê przyda. Zegnaj i mam nadziejê, i¿ wkrótce zaznasz spokoju.

	Wld_InsertItem (ItNa_Pierscien_Zarazy,"FP_NASZ_PIERSCIEN_GHORIM");
	
	B_LogEntry (TOPIC_Lojalnosc,"W nagrodê za pomoc Ghorim zaoferowa³ mi swój pier¶cieñ, niestety duch nie mia³ go przy sobie. Wskaza³ mi jednak miejsce gdzie mo¿e siê znajdowaæ. Czas przeszukaæ jego chatê i jej okolice.");
