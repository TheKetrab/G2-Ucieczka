...
func void B_InitMonsterAttitudes ()
{
	...
	B_SetMonsterAttitude	(GIL_GOBBO_SKELETON,	ATT_NEUTRAL,	GIL_FRIENDLY_ORC			);	
	...
	B_SetMonsterAttitude	(GIL_SUMMONED_GOBBO_SKELETON,	ATT_NEUTRAL,	GIL_BLOODFLY				);
	...
	B_SetMonsterAttitude	(GIL_WOLF,	ATT_NEUTRAL,	GIL_MOLERAT					);	
	...
	B_SetMonsterAttitude	(GIL_SKELETON,	ATT_NEUTRAL,	GIL_LURKER					);
	...
	B_SetMonsterAttitude	(GIL_SKELETON,	ATT_NEUTRAL,	GIL_MOLERAT					);	
	B_SetMonsterAttitude	(GIL_SKELETON,	ATT_NEUTRAL,	GIL_ORC						);	// Ork-Krieger / Ork-Shamane / Ork-Elite
	B_SetMonsterAttitude	(GIL_SKELETON,	ATT_NEUTRAL,	GIL_FRIENDLY_ORC			);	
	...
	B_SetMonsterAttitude	(GIL_SKELETON_MAGE,	ATT_NEUTRAL,	GIL_ORC						);	// Ork-Krieger / Ork-Shamane / Ork-Elite
	B_SetMonsterAttitude	(GIL_SKELETON_MAGE,	ATT_NEUTRAL,	GIL_FRIENDLY_ORC			);	
	...
	B_SetMonsterAttitude	(GIL_ZOMBIE,	ATT_NEUTRAL,	GIL_MOLERAT					);	
	B_SetMonsterAttitude	(GIL_ZOMBIE,	ATT_NEUTRAL,	GIL_ORC						);	// Ork-Krieger / Ork-Shamane / Ork-Elite
	B_SetMonsterAttitude	(GIL_ZOMBIE,	ATT_NEUTRAL,	GIL_FRIENDLY_ORC			);	
	...
	B_SetMonsterAttitude	(GIL_SHADOWBEAST,	ATT_NEUTRAL,	GIL_SCAVENGER				);
	...
	B_SetMonsterAttitude	(GIL_SHADOWBEAST_SKELETON,	ATT_NEUTRAL,	GIL_SCAVENGER				);
