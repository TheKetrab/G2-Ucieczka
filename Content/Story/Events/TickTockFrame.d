...
func void KillDemonPosag()
{
	if(WillIsGoingToKillDemonPosag == 1 && WillZniszczylDemonaOneTime == FALSE )
	{
		...
		{
			// TODO: bogu if item is młot
			if (bIsHammer(itm))
			{
				B_LogEntry (TOPIC_Erak_plagaciemnosci, "Kapliczka została zniszczona, a wraz z nią zagrożenie jakie deptało nam po piętach. Czym prędzej wrócę do maga i opowiem mu o tym co się tutaj stało. Poza tym dziwię się, że nie zaatakował mnie żaden demon. Czyżby mag się mylił?");
