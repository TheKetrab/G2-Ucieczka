instance NASZ_999_Test (Npc_Default)
{
	...
	// Sakwy-paczki
	CreateInvItems (self, Recepture,1);
	CreateInvItems (self, Project,1);
	CreateInvItems (self, G1Swords,1);
	CreateInvItems (self, Helmet,1);
	CreateInvItems (self, Shield,1);
	...
	CreateInvItems (self, ItNa_Key_KorthPiwo,1);
	...
	CreateInvItems (self, ItNa_Key_Ben,1);
	CreateInvItems (self, ItNa_Key_WielkiDom,1);
	CreateInvItems (self, ItNa_Key_Robotnik,1);
	CreateInvItems (self, ItNa_Key_CatSan,1);
