...
INSTANCE DIA_NASZ_999_Test_GoldNugget   (C_INFO)
{
	npc         = NASZ_999_Test;
 	...
 	permanent   = TRUE;
 	description = "Dodaj bry³ki z³ota.";
};
...
FUNC VOID DIA_NASZ_999_Test_GoldNugget_Info()
{
	Info_ClearChoices (DIA_NASZ_999_Test_GoldNugget);
		...
		Info_AddChoice	  (DIA_NASZ_999_Test_GoldNugget, "100 bry³ek z³ota", DIA_NASZ_999_Test_GoldNugget_100);
		Info_AddChoice	  (DIA_NASZ_999_Test_GoldNugget, "25 bry³ek z³ota", DIA_NASZ_999_Test_GoldNugget_25);
		Info_AddChoice	  (DIA_NASZ_999_Test_GoldNugget, "5 bry³ek z³ota", DIA_NASZ_999_Test_GoldNugget_5);
};
