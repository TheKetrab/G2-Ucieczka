...
const int	Value_Apple		=	8;		const int	HP_Apple		=	5;
const int	Value_Cheese	=	30;		const int	HP_Cheese		=	7;
const int	Value_Bacon		=	50;		const int	HP_Bacon		=	10;
const int	Value_Bread		=	20;		const int	HP_Bread		=	12;
const int	Value_Fish		=	15;		const int	HP_Fish			=	9;
const int	Value_Rawmeat	=	3;		const int	HP_RawMeat		=	6;
const int	Value_Meat		=	6;		const int	HP_Meat			=	8;
const int	Value_Stew		=	8;		const int	HP_Stew			=	15;
const int	Value_FishSoup	=	20;		const int	HP_FishSoup		=	12;
const int	Value_Sausage	=	30;		const int	HP_Sausage		=	9;
const int	Value_Honey		=	30;		const int	HP_Honey		=	7;

const int	Value_Water		=	10;		const int	HP_Water		=	2;
const int	Value_Beer		=	20;		const int	HP_Beer			=	-5;	const int	Mana_Beer		=	5;
const int	Value_Booze		=	15;		const int	HP_Booze		=	-5;	const int	Mana_Booze		=	7;
const int	Value_Wine		=	20;		const int	HP_Wine			=	-4;	const int	Mana_Wine		=	8;
const int	Value_Milk		=	15; 	const int	HP_Milk			=	5;	const int	Mana_Milk		=	8;	// Joly: Wenn diese Werte geändert werden passt Lobarts Auftrag holMilch nicht mehr!!!!!!
...
{	
	...
	{
		PercentHealSelf(7,ATR_HITPOINTS);
...
{	
	...
	FUNC VOID Use_Fish()
	{
		PercentHealSelf(9,ATR_HITPOINTS);
...
{	
	...
	FUNC VOID Use_CoragonsBeerBeer()
	{
		...
		B_RaiseAttribute	(self,	ATR_MANA_MAX,	Mana_Beer,FALSE);
...
{	
	...
	FUNC VOID Use_Water()
	{
		PercentHealSelf(2,ATR_HITPOINTS);
	};
