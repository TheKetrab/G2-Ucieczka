...
INSTANCE DIA_NASZ_130_Jenkins_hello   (C_INFO)
{
	npc         = NASZ_130_Jenkins;
 	...
 	permanent   = FALSE;
	description = "Udar wys³a³ mnie bym sprawdziæ co siê z wami sta³o.";
};
...
{
	AI_Output (other, self,"DIA_NASZ_130_Jenkins_hello_15_00"); //Udar wys³a³ mnie bym sprawdziæ co siê z wami sta³o.
	...
	AI_Output (self, other,"DIA_NASZ_130_Jenkins_hello_15_07"); //To nie by³ taki zwyk³y zlepek orkowych s³ów. Kiedy ka¿dy z nas znalaz³ siê w ich zasiêgu, poczuliœmy olbrzymie bóle g³owy, a nasze oczy poczê³y zachodziæ mrokiem tak jakby ktoœ wys³a³ nas do najmroczniejszych zak¹tków wymiaru demonów.
	AI_Output (self, other,"DIA_NASZ_130_Jenkins_hello_15_08"); //Ciê¿ko mi to opisaæ, ale czu³em siê, tak jakby moja dusza by³a wydzierana z mego cia³a. Ten ból, to wszystko by³o nie do wytrzymania.
	AI_Output (other, self,"DIA_NASZ_130_Jenkins_hello_15_09"); //Mo¿esz mi przet³umaczyæ te s³owa?
	AI_Output (self, other,"DIA_NASZ_130_Jenkins_hello_15_10"); //Oczywiœcie, gotów?
...
func void DIA_NASZ_130_Jenkins_hello_yep() {
	...
	AI_Output (self, other,"DIA_NASZ_130_Jenkins_hello_yep_15_02"); //Nienaturalne zimo przeszywaj¹ce tw¹ duszê tak jakby ktoœ przeszed³ po twoim grobie?
...
FUNC VOID DIA_NASZ_130_Jenkins_EndOfMatt_Info()
{
	...
	AI_Output (self, other,"DIA_NASZ_130_Jenkins_EndOfMatt_15_08"); //Zaœ co do Matta... To by³ dobry ³owca orków. Tobie natomiast nalez¹ siê podziêkowania za pomoc.
