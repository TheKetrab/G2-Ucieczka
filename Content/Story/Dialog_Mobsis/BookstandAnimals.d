...
FUNC VOID Use_PrzemianaBook_S1()		//Tierbücher
{
	var C_NPC her; 	her = Hlp_GetNpc(PC_Hero); 
	...
	{	
		...
		nDocID = 	Doc_Create		()			  ;							
					...
					Doc_PrintLine	( nDocID,  0, ""						);
					Doc_PrintLine	( nDocID,  0, "Wabienie wilków"					);
					Doc_PrintLine	( nDocID,  0, ""						);
					Doc_PrintLine	( nDocID,  0, ""						);
					Doc_PrintLines	( nDocID,  0, "Oprócz strza³, zrêcznoœci i celnoœci, istnieje coœ takiego, jak przebieg³oœæ. Jeœli ktoœ sprawnie pos³uguje siê t¹ cech¹, ma szansê zabijaæ zwierzynê z du¿o wiêksz¹ skutecznoœci¹."						);
					Doc_PrintLine	( nDocID,  0, ""						);
					Doc_PrintLines	( nDocID,  0, "~Peren, mistrz zwojów"						);
