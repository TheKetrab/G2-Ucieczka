...
{
	// od trzeciego rozdzia³u da siê tylko na to rozmawiaæ,
	// bo inaczej da³oby siê zrobiæ questa z Rethonem treningiem
	...
	if (
		...
		&& ((LOWCA_STOP_GADANIE == FALSE)
		 || (LOWCA_STOP_GADANIE == TRUE && Wld_IsTime(02,00,23,30)))
