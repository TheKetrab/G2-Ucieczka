...
func int B_TeachMagicCircle (var C_NPC slf, var C_NPC oth, var int circle)
{
	...
	if (circle < 1) || (circle > 6)
	{
		...
		PrintS_Ext("*** B³¹d: Z³y parametr ***", RGBA(255,255,255,0));
		return FALSE;
	};
	...
	if (circle == 1)
	{
		...
		PrintS_Ext(PRINT_LearnCircle_1, RGBA(255,255,255,0));
	...
	if (circle == 2)
	{
		...
		PrintS_Ext(PRINT_LearnCircle_2, RGBA(255,255,255,0));
	...
	if (circle == 3)
	{
		...
		PrintS_Ext(PRINT_LearnCircle_3, RGBA(255,255,255,0));
	...
	if (circle == 4)
	{
		...
		PrintS_Ext(PRINT_LearnCircle_4, RGBA(255,255,255,0));
	...
	if (circle == 5)
	{
		...
		PrintS_Ext(PRINT_LearnCircle_5, RGBA(255,255,255,0));
	...
	if (circle == 6)
	{
		...
		PrintS_Ext(PRINT_LearnCircle_6, RGBA(255,255,255,0));
