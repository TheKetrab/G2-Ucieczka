...
instance MENUITEM_SAVE_SLOT1(C_MENU_ITEM_DEF)
{
	...
	text[0] = "nieznane";
	text[1] = "1 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT2(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "2 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT3(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "3 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT4(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "4 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT5(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "5 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT6(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "6 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT7(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "7 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT8(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "8 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT9(C_MENU_ITEM_DEF)
{
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "9 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT10(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "10 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT11(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "11 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT12(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "12 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT13(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "13 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT14(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "14 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT15(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "15 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT16(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "16 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT17(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "17 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT18(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "18 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT19(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "19 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
...
instance MENUITEM_SAVE_SLOT20(C_MENU_ITEM_DEF)
{
	...
	type = MENU_ITEM_INPUT;
	text[0] = "nieznane";
	text[1] = "20 zapis - wciœnij [Enter] i wpisz nazwê stanu gry";
	posx = SAVEGAME_X1;
