...
instance PC_PrayIdol_Ofiara(C_Info)
{
	npc = PC_Hero;
	nr = 1;
	condition = PC_PrayIdol_Ofiara_Condition;
	information = PC_PrayIdol_Ofiara_Info;
	permanent = TRUE;
	description = "Z³ó¿ w ofierze 2 tysi¹ce sztuk z³ota.";
};
...
func void PC_PrayIdol_Ofiara_Info()
{
	B_giveinvitems (hero, NASZ_404_Beliar, Itmi_Gold, 2000);
	OFIARA = TRUE;
	AI_Teleport		(NASZ_404_Beliar, "NASZ_DYMOONDO_L");
