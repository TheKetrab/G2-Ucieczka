...
//	Kuro'K   														
//*************************
INSTANCE KuroK (Mst_Default_OrcElite)
{
	name = "Kuro'K";
...
INSTANCE OrcElite_TwierdzaA (Mst_Default_OrcElite)
{
	//-------- visual --------
	B_SetVisuals_OrcElite();
...
INSTANCE OrcElite_TwierdzaB (Mst_Default_OrcElite)
{
	//-------- visual --------
	B_SetVisuals_OrcElite();
...
INSTANCE OrcElite_TwierdzaC (Mst_Default_OrcElite)
{
	//-------- visual --------
	B_SetVisuals_OrcElite();
...
//******** ZAMEK ***********
INSTANCE OrcElite_ZamekA (Mst_Default_OrcElite)
{
	//-------- visual --------
	B_SetVisuals_OrcElite();
...
INSTANCE OrcEliteHerszt (Mst_Default_OrcElite)
{
	name = "Ork-Dowódca";
	level = 85;
...
//******** Fort Friendly ***********
INSTANCE OrcElite_FortA (Mst_Default_OrcElite)
{
	//-------- visual --------
	B_SetVisuals_OrcElite();
...
INSTANCE OrcElite_FortB (Mst_Default_OrcElite)
{
	//-------- visual --------
	B_SetVisuals_OrcElite();
