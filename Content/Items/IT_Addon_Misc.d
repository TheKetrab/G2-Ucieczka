...
instance ItMi_BaltramPaket(C_Item)
{
	...
	material = MAT_LEATHER;
	description = name;
	text[2] = "Ciê¿ka przesy³ka";
	text[3] = "od farmera Akila";
};
...
instance ItMi_Packet_Baltram4Skip_Addon(C_Item)
{
	...
	text[3] = "jest przeznaczona dla Skipa";
};
...
instance ItMi_BromorsGeld_Addon(C_Item)
{
	...
	material = MAT_METAL;
	description = name;
	text[2] = "Na jej spodzie";
	text[3] = "wyryto imiê 'Bromor'";
	text[5] = NAME_Value;
	count[5] = value;
};
...
{
	name = "Skórzana paczka Cavalorna";
	mainflag = ITEM_KAT_NONE;
	flags = ITEM_MULTI | ITEM_MISSION;
	value = Value_Nugget;
	...
	description = name;
	text[0] = "";
	text[1] = "Podpisana imieniem 'Cavalorn'";
	text[2] = "W œrodku znajduje siê bry³ka rudy";
	text[4] = "";
	text[5] = NAME_Value;
	count[5] = value;
};
