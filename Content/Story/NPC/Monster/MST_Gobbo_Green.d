...
INSTANCE goblin6 (Mst_Default_Gobbo_Green)
{
	B_SetVisuals_Gobbo_Green();
	Npc_SetToFightMode (self, ItMw_1h_Bau_Mace);
};

INSTANCE goblin7 (Mst_Default_Gobbo_Green)
{
	B_SetVisuals_Gobbo_Green();
	Npc_SetToFightMode (self, ItMw_1h_Bau_Mace);
};

INSTANCE goblin8 (Mst_Default_Gobbo_Green)
{
	B_SetVisuals_Gobbo_Green();
	Npc_SetToFightMode (self, ItMw_1h_Bau_Mace);
};

INSTANCE goblin9 (Mst_Default_Gobbo_Green)
{
	B_SetVisuals_Gobbo_Green();
	Npc_SetToFightMode (self, ItMw_1h_Bau_Mace);
};

INSTANCE goblin10 (Mst_Default_Gobbo_Green)
{
	B_SetVisuals_Gobbo_Green();
	Npc_SetToFightMode (self, ItMw_1h_Bau_Mace);
};
