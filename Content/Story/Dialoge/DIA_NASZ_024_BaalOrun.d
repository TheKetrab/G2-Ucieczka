...
func void DIA_NASZ_024_BaalOrun_Droga_Info ()
{
	...
	AI_Output			(self, other, "DIA_NASZ_024_BaalOrun_Droga_024_02"); //Niestety, wojowniku, nie mo¿esz po prostu wejœæ do wnêtrza naszej œwi¹tyni, gdy¿ ta zosta³a zapieczêtowana i nikt nie ma do niej dostêpu. Jakakolwiek próba sforsowania kamiennych wrót skoñczy siê dla ciebie œmierci¹.
	AI_Output			(other, self, "DIA_NASZ_024_BaalOrun_Droga_15_03"); //Wiêc powiedz mi, jak mogê dostaæ siê do jej wnêtrza i przegnaæ znajduj¹ce siê wewn¹trz z³o. Przecie¿ musi byæ jakiœ sposób!
	AI_Output			(self, other, "DIA_NASZ_024_BaalOrun_Droga_024_04"); //To by³o tak dawno... Mój umys³ jak i wspomnienia s¹ teraz jedynie strzêpami wszystkiego co wiedzia³em, pogr¹¿one w wiecznej pustce jak moje zagubione ja zdaj¹ siê byæ nieuchwytne, niedoœcignione...
	AI_Output			(self, other, "DIA_NASZ_024_BaalOrun_Droga_024_05"); //Ponadto nie mo¿emy pomóc ci bezpoœrednio. Jarzmo kl¹twy uniemo¿liwia nam sprzeciwienie siê naszemu panu. Musia³byœ znaleŸæ coœ co pomog³oby ci siê do niego dostaæ, lecz niewiele ju¿ pamiêtam.
	AI_Output			(other, self, "DIA_NASZ_024_BaalOrun_Droga_15_06"); //¯y³eœ w okresie kiedy to wszystko siê rozegra³o, skup siê i przypomnij to sobie!
	...
	AI_Output			(self, other, "DIA_NASZ_024_BaalOrun_Droga_024_09"); //Jeden z nich wyci¹ga kartkê... Nie, magiczny pergamin... I zaczyna coœ na nim spisywaæ. Dopiero teraz dostrzegam mrok, jaki ogarnia nasze sylwetki. Coœ co zdaje siê nas poch³aniaæ.
	...
	AI_Output			(self, other, "DIA_NASZ_024_BaalOrun_Droga_024_11"); //Nie wiedzieæ czemu, mam silne wra¿enie, i¿ zapisane nañ s³owa s¹ kluczem do rozwi¹zania naszej zagadki. Je¿eli chcesz poznaæ odpowiedŸ na swoje pytania musisz odszukaæ fragmenty stronicy i mi je dostarczyæ.
	AI_Output			(self, other, "DIA_NASZ_024_BaalOrun_Droga_024_12"); //Czujê magiczn¹ si³ê, która bije od spisanych tam s³ów. Nie mogê dok³adnie okreœliæ sk¹d, lecz wszystkie fragmenty znajduj¹ siê w naszym obozie. Ruszaj i strze¿ siê umar³ych, którzy nie mog¹ zaznaæ spokoju.
...
{
	// TODO: bogu -> po ka¿dym zabraniu zwoju, pojawia sie wojownik cienia
...
func void DIA_NASZ_024_BaalOrun_RytualCD_Info ()
{
	...
	AI_Output			(self, other, "DIA_NASZ_024_BaalOrun_RytualCD_024_02"); //Nim ruszysz do œwi¹tyni musisz u¿yæ zwoju, który powsta³ przez po³¹czenie kawa³ków znalezionych przez ciebie. Dziêki temu bêdziesz traktowany jako pe³noprawny cz³onek Bractwa i magiczna bariera przy wejœciu do œwi¹tyni ciê nie powstrzyma.
	AI_Output			(self, other, "DIA_NASZ_024_BaalOrun_RytualCD_024_03"); //Ale uprzedzam ciê! U¿yj zwoju dopiero wtedy, gdy za³o¿ysz na siebie wszystkie artefakty. WeŸ kolejny: Ten amulet to znak okazania nam pomocy w odzyskaniu pe³nej œwiadomoœci.
