...
instance MENUITEM_GRA_TEXQUAL(C_MENU_ITEM_DEF)
{
	...
	text[0] = "Tekstury";
	text[1] = "Wybór iloœci detali na teksturach";
	posx = 1000;
...
instance MENUITEM_GRA_MODEL_DETAIL(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Modele";
	text[1] = "Wybór iloœci detali na modelach";
	posx = 1000;
...
instance MENUITEM_GRA_SIGHT(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Wybór zasiêgu widzenia, w procentach";
	posx = 1000;
...
instance MENUITEM_VOB_SIGHT(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Wybór zasiêgu, z jakiego widoczne bêd¹ obiekty";
	posx = 1000;
...
instance MENUITEM_GRA_SKY_EFFECTS(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Niebo";
	text[1] = "W³¹czenie/wy³¹czenie dodatkowych efektów nieba";
	posx = 1000;
