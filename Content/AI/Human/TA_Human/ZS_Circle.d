		...
		if (Npc_GetStateTime(self) > randyKDW)
			{
				...
				AI_PlayAni (NASZ_402_Innos,"T_PRACTICEMAGIC5");	
				Wld_PlayEffect("spellFX_INCOVATION_RED",  NASZ_402_Innos, NASZ_402_Innos, 0, 0, 0, FALSE );

				AI_PlayAni  (NASZ_403_Adanos,"T_MAGRUN_2_HEASHOOT");
				AI_PlayAni  (NASZ_403_Adanos,"T_HEASHOOT_2_STAND");
				Wld_PlayEffect("spellFX_INCOVATION_GREEN",  NASZ_403_Adanos, NASZ_403_Adanos, 0, 0, 0, FALSE );

				AI_PlayAni  (NASZ_404_Beliar,"T_MAGRUN_2_FEASHOOT");
				AI_PlayAni  (NASZ_404_Beliar,"T_FEASHOOT_2_STAND");
				Wld_PlayEffect("spellFX_INCOVATION_VIOLET",  NASZ_404_Beliar, NASZ_404_Beliar, 0, 0, 0, FALSE );
