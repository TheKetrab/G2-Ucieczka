...
func VOID CH_Guild_Info()
{
    ...
    Info_AddChoice	(CH_Guild, "Stra¿nik miejski"       	, CH_MIL);    
...
FUNC VOID DIA_CH_Runen_Info()
{
	...
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("6. Kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 6))			,DIA_CH_Runen_6);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 4)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("5. Kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 5))			,DIA_CH_Runen_5);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 3)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("4. Kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 4))			,DIA_CH_Runen_4);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 2)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("3. Kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 3))			,DIA_CH_Runen_3);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) == 1)
	{
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("2. Kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 2))			,DIA_CH_Runen_2);
	};
	if (Npc_GetTalentSkill (other, NPC_TALENT_MAGE) < 1)
	{ 
		Info_AddChoice		(DIA_CH_Runen, B_BuildLearnString("1. Kr¹g magii"	, B_GetLearnCostTalent(other, NPC_TALENT_MAGE, 1))			,DIA_CH_Runen_1);
	};
};
//**********************************************************
// BACK
...
INSTANCE DIA_CH_Kampf_Start (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Umiejêtnoœci bojowe (walka wrêcz i d³ugodystansowa)";
};                       
...
FUNC VOID DIA_CH_Kampf_Einhand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Broñ jednorêczna + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*20)		,CH_Training_Combat_1H_20);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Broñ jednorêczna + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*10)		,CH_Training_Combat_1H_10);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Broñ jednorêczna + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1)*5)		,CH_Training_Combat_1H_5);
	Info_AddChoice		(DIA_CH_Kampf_Einhand, B_BuildLearnString("Broñ jednorêczna + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_1H, 1))		,CH_Training_Combat_1H_1);
};
...
FUNC VOID DIA_CH_Kampf_Zweihand_Info()
{
	...
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Broñ dwurêczna + 20"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*20)			,CH_Training_Combat_2H_20);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Broñ dwurêczna + 10"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*10)			,CH_Training_Combat_2H_10);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Broñ dwurêczna + 5"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1)*5)				,CH_Training_Combat_2H_5);
	Info_AddChoice		(DIA_CH_Kampf_Zweihand, B_BuildLearnString("Broñ dwurêczna + 1"	, B_GetLearnCostTalent(other, NPC_TALENT_2H, 1))				,CH_Training_Combat_2H_1);
};
...
FUNC VOID DIA_CH_Dieb_Steal_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Steal, B_BuildLearnString("Kradzie¿ kieszonkowa"	, B_GetLearnCostTalent(other, NPC_TALENT_PICKPOCKET, 1))		,CH_Training_Thief_Pickpocket);
};
//*********************************************
//Dieb Schleichen
//*********************************************
...
FUNC VOID DIA_CH_Dieb_Schleichen_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Schleichen, B_BuildLearnString("Skradanie"	, B_GetLearnCostTalent(other, NPC_TALENT_SNEAK, 1))		,CH_Training_Thief_Sneak);
};
//*********************************************
...
FUNC VOID DIA_CH_Dieb_Picklock_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Picklock , B_BuildLearnString("Otwieranie zamków"	, B_GetLearnCostTalent(other, NPC_TALENT_PICKLOCK, 1))		,CH_Training_Thief_Picklock);
};
//*********************************************
...
FUNC VOID DIA_CH_Dieb_Alle_Info()
{
	...
	Info_AddChoice		(DIA_CH_Dieb_Alle , B_BuildLearnString("Nauka wszystkich umiejêtnoœci z³odziejskich", kosten_alle), CH_Training_Thief_Alle);
};
//***************************************************************************
...
INSTANCE DIA_CH_Misc_Health (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Mikstury uzdrawiaj¹ce";
};                       
...
FUNC VOID DIA_CH_Misc_Health_Info()
{
	...
	{
		Info_AddChoice	  (DIA_CH_Misc_Health, B_BuildLearnString ("Mikstura ¿ycia", 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_Health)), CH_Training_Alchemy_POTION_Perm_Health);
	};
};
...
FUNC VOID DIA_CH_Misc_Mana_Info()
{
	...
	{
		Info_AddChoice	  (DIA_CH_Misc_Mana, B_BuildLearnString ("Eliksir ducha"	, 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_Mana)), CH_Training_Alchemy_POTION_Perm_Mana);
	};
...
FUNC VOID DIA_CH_Misc_Special_Info()
{
	...
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("£adowanie Oka Innosa", 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, CHARGE_Innoseye)), CH_Training_Alchemy_Charge_InnosEye);
	};
	...
	{
		Info_AddChoice	  (DIA_CH_Misc_Special, B_BuildLearnString ("Eliksir zrêcznoœci"		, 	B_GetLearnCostTalent (other, NPC_TALENT_ALCHEMY, POTION_Perm_DEX)), CH_Training_Alchemy_POTION_Perm_DEX);
	};
...
INSTANCE DIA_CH_Misc_Animal_allg (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Zêby, futro, pazury, serca";
};                       
...
FUNC VOID DIA_CH_Misc_Animal_allg_Info()
{
	...
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_allg, B_BuildLearnString ("Wyrywanie k³ów",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Teeth)),  CH_Training_TROPHYS_Teeth);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_Claws] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_allg, B_BuildLearnString ("Wyci¹ganie pazurów",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Claws)),  CH_Training_TROPHYS_Claws);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_Fur] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_allg, B_BuildLearnString ("Usuwanie skór",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Fur)),  CH_Training_TROPHYS_Fur);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_Heart] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_allg, B_BuildLearnString ("Wyci¹ganie serca",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Heart)),  CH_Training_TROPHYS_Heart);
	};
};
...
INSTANCE DIA_CH_Misc_Animal_Speziell (C_INFO)
{
	...
	permanent	= TRUE;
	description = "Skrzyd³a, ¿¹d³o, ¿uwaczki, p³ytki";
};                       
...
FUNC VOID DIA_CH_Misc_Animal_Speziell_Info()
{
	...
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("Usuwanie ¿¹d³a krwiopijcy",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFSting)),  CH_Training_TROPHYS_BFSting);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_BFWing] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("Odcinanie skrzyde³",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_BFWing)),  CH_Training_TROPHYS_BFWing);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_CrawlerPlate] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("Usuwanie p³ytek pancerza pe³zacza",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_CrawlerPlate)),  CH_Training_TROPHYS_CrawlerPlate	);
	};
	if (PLAYER_TALENT_TAKEANIMALTROPHY [TROPHY_Mandibles] == FALSE)
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_Speziell, B_BuildLearnString ("Usuwanie ¿uwaczek",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_Mandibles)),  CH_Training_TROPHYS_Mandibles	);
	};
};
//--------------------------------------------
...
FUNC VOID DIA_CH_Misc_Animal_other_Info()
{
	...
	{ 
		Info_AddChoice	(DIA_CH_Misc_Animal_other, B_BuildLearnString ("Odcinanie jêzyków",B_GetLearnCostTalent (other,NPC_TALENT_TAKEANIMALTROPHY, TROPHY_FireTongue)),  CH_Training_TROPHYS_FireTongue);
	};
