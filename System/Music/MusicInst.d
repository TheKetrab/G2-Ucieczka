...
INSTANCE UCO_Day_Std	(C_MUSICTHEME_DEF)	{	file			= "cam_day_std.sgt";	
												transType		= TRANSITION_TYPE_BREAK;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};
												
INSTANCE UCO_Day_Thr	(C_MUSICTHEME_DEF)	{	file			= "cam_day_thr.sgt";
												transType		= TRANSITION_TYPE_BREAK;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};

INSTANCE UCO_Day_Fgt	(C_MUSICTHEME_DEF)	{	file			= "cam_day_fgt.sgt";
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};

                                                                
INSTANCE UCO_Ngt_Std	(C_MUSICTHEME_DEF)	{	file			= "cam_ngt_std.sgt";					};
INSTANCE UCO_Ngt_Thr	(C_MUSICTHEME_DEF)	{	file			= "cam_ngt_std.sgt";					};
INSTANCE UCO_Ngt_Fgt	(C_MUSICTHEME_DEF)	{	file			= "cam_ngt_std.sgt";					};

// Höhle

INSTANCE UCI_Day_Std	(C_MUSICTHEME_DEF)	{	file			= "nci_day_std.sgt";
												transType		= TRANSITION_TYPE_BREAK;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};

INSTANCE UCI_Day_Thr	(C_MUSICTHEME_DEF)	{	file			= "nci_day_std.sgt";
												transType		= TRANSITION_TYPE_BREAK;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};

INSTANCE UCI_Day_Fgt	(C_MUSICTHEME_DEF)	{	file			= "nci_day_fgt.sgt";					
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};
                                                                
INSTANCE UCI_Ngt_Std	(C_MUSICTHEME_DEF)	{	file			= "nci_day_std.sgt";					};
INSTANCE UCI_Ngt_Thr	(C_MUSICTHEME_DEF)	{	file			= "nci_day_std.sgt";					};
INSTANCE UCI_Ngt_Fgt	(C_MUSICTHEME_DEF)	{	file			= "nci_day_fgt.sgt";					
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};
...
INSTANCE OME_Day_Fgt	(C_MUSICTHEME_DEF)	{	file			= "nci_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};
...
INSTANCE OLM_Ngt_Fgt	(C_MUSICTHEME_DEF)	{	file			= "olm_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};												
...
// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
// XXXXXXXX  GROTA [KOP_]   XXXX
// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
// 

INSTANCE KOP_Day_Std	(C_MUSICTHEME_DEF)	{	file			= "olm_day_std.sgt";					};
INSTANCE KOP_Ngt_Std	(C_MUSICTHEME_DEF)	{	file			= "olm_day_std.sgt";					};
INSTANCE KOP_Day_Fgt	(C_MUSICTHEME_DEF)	{	file			= "oc_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};

INSTANCE KOP_Ngt_Fgt	(C_MUSICTHEME_DEF)	{	file			= "oc_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};												


// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
// XXXXXXXX  KOPALNIA [POK_]   XXXX
// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
// 

INSTANCE POK_Day_Std	(C_MUSICTHEME_DEF)	{	file			= "olm_day_std.sgt";
												transType		= TRANSITION_TYPE_BREAK;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};

INSTANCE POK_Ngt_Std	(C_MUSICTHEME_DEF)	{	file			= "olm_day_std.sgt";
												transType		= TRANSITION_TYPE_BREAK;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};
																								
INSTANCE POK_Day_Thr	(C_MUSICTHEME_DEF)	{	file			= "olm_day_thr.sgt";
												transType		= TRANSITION_TYPE_BREAK;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};
												
INSTANCE POK_Day_Fgt	(C_MUSICTHEME_DEF)	{	file			= "olm_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};
												
INSTANCE POK_Ngt_Fgt	(C_MUSICTHEME_DEF)	{	file			= "olm_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};		

// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
// XXXXXXXX  ŒWI¥TYNIA [SWT_]   XXXX
// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
// 

INSTANCE SWT_Day_Std	(C_MUSICTHEME_DEF)	{	file			= "ogy_day_std.sgt";					};
INSTANCE SWT_Ngt_Std	(C_MUSICTHEME_DEF)	{	file			= "ogy_day_std.sgt";					};
INSTANCE SWT_Day_Fgt	(C_MUSICTHEME_DEF)	{	file			= "psi_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};

INSTANCE SWT_Ngt_Fgt	(C_MUSICTHEME_DEF)	{	file			= "psi_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};	

// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
// XXXXXXXX  THEROCK [ROC_]   XXXX
// XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
// 

INSTANCE ROC_Day_Std	(C_MUSICTHEME_DEF)	{	file			= "orc_day_std.sgt";						
												transType		= TRANSITION_TYPE_BREAK;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};
											
INSTANCE ROC_Day_Thr	(C_MUSICTHEME_DEF)	{	file			= "orc_day_std.sgt";						
												transType		= TRANSITION_TYPE_BREAK;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};

INSTANCE ROC_Day_Fgt	(C_MUSICTHEME_DEF)	{	file			= "oc_day_fgt.sgt";						
												transType		= TRANSITION_TYPE_FILL;
												transSubType	= TRANSITION_SUB_TYPE_MEASURE;			};

INSTANCE ROC_Ngt_Std	(C_MUSICTHEME_DEF)	{	file			= "orc_day_std.sgt";					};
INSTANCE ROC_Ngt_Thr	(C_MUSICTHEME_DEF)	{	file			= "orc_day_std.sgt";					};
INSTANCE ROC_Ngt_Fgt	(C_MUSICTHEME_DEF)	{	file			= "oc_day_fgt.sgt";						};									
