...
instance MENUITEM_OPT_GAME(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Zmiana ustawieñ rozgrywki";
	posx = 0;
...
instance MENUITEM_OPT_GRAPHICS(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Pole widzenia, iloœæ szczegó³ów i efekty specjalne";
	posx = 0;
...
instance MENUITEM_OPT_VIDEO(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Karta graficzna, rozdzielczoœæ, jasnoœæ i kontrast";
	posx = 0;
...
instance MENUITEM_OPT_AUDIO(C_MENU_ITEM_DEF)
{
	...
	text[1] = "Muzyka, efekty dŸwiêkowe i sekwencje mówione";
	posx = 0;
