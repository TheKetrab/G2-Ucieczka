...
const int 	ID_ORCSCOUT					= 65;
const int 	ID_GIGANT					= 66;
...
//NASZ
const int FAI_HUMAN_COMBO				= 47	;
const int FAI_HUMAN_MASTER2				= 48	;
...
const int	MOBSI_DESTYLACJA				= 8; //nasz
const int	MOBSI_NUGGETHACKEN				= 9; //nasz
const int	MOBSI_SMAZENIE					= 10; //nasz
const int	MOBSI_COALHACKEN				= 11; //nasz
const int	MOBSI_CRYSTALHACKEN				= 12; //nasz
const int	MOBSI_CRYSTALPOWER				= 13; //nasz
const int	MOBSI_PIEDESTAL1				= 14; //nasz
const int	MOBSI_PIEDESTAL2				= 15; //nasz
const int	MOBSI_PIEDESTAL3				= 16; //nasz
...
const int ZombiePale	= 13;
const int ZombieBlack	= 14;

const int BodyTexMiner_P = 15;
const int BodyTexMiner_N = 16;
const int BodyTexMiner_B = 17;
...
const int Face_B_Sattar		= 	168;
const int Face_N_Netbek		= 	169;
const int Face_N_Orun		=   170;
const int Face_N_Shrat		=   171;
const int Face_N_Joru		=   172;
const int Face_N_Ghorim		=   173;
const int Face_P_Nod		=   174;
const int Face_N_Gobby		=   175;
const int Face_P_Monk		=   176;
...
const int Face_P_Monastir	=   182;
const int Face_L_Kivo		=   183;
const int Face_L_Rabon		=   184;