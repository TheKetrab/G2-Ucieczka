...
instance MENU_OPT_CONTROLS(C_MENU_DEF)
{
	...
	//items[0] = "MENU_ITEM_KEY_HIDEQUICKSLOT";
	//items[1] = "MENU_ITEM_INP_HIDEQUICKSLOT";
	...
	items[13] = "MENU_ITEM_KEY_MAP";
	items[14] = "MENU_ITEM_KEY_HIDEQUICKSLOT";
	items[15] = "MENU_ITEM_KEY_LOOK";
	items[16] = "MENU_ITEM_KEY_LOOK_FP";
	items[17] = "MENU_ITEM_KEY_INVENTORY";
	items[18] = "MENU_ITEM_KEY_SCREEN_STATUS";
	items[19] = "MENU_ITEM_KEY_SCREEN_LOG";
	items[20] = "MENU_ITEM_INP_UP";
	items[21] = "MENU_ITEM_INP_DOWN";
	items[22] = "MENU_ITEM_INP_LEFT";
	items[23] = "MENU_ITEM_INP_RIGHT";
	items[24] = "MENU_ITEM_INP_STRAFE_LEFT";
	items[25] = "MENU_ITEM_INP_STRAFE_RIGHT";
	items[26] = "MENU_ITEM_INP_JUMPCLIMBSTRAFE";
	items[27] = "MENU_ITEM_INP_RUNMODETOGGLE";
	items[28] = "MENU_ITEM_INP_SNEAK";
	items[29] = "MENU_ITEM_INP_ACTION";
	items[30] = "MENU_ITEM_INP_WEAPON";
	items[31] = "MENU_ITEM_INP_MAP";
	items[32] = "MENU_ITEM_INP_HIDEQUICKSLOT";
	items[33] = "MENU_ITEM_INP_LOOK";
	items[34] = "MENU_ITEM_INP_LOOK_FP";
	items[35] = "MENU_ITEM_INP_INVENTORY";
	items[36] = "MENU_ITEM_INP_SCREEN_STATUS";
	items[37] = "MENU_ITEM_INP_SCREEN_LOG";
	items[38] = "MENU_ITEM_CHG_KEYS_SET_DEFAULT";
	items[39] = "MENU_ITEM_CHG_KEYS_SET_ALTERNATIVE";
	items[40] = "MENUITEM_CHG_KEYS_BACK";
	items[41] = "MENU_ITEM_NEXTMENU";
...
instance MENU_ITEM_KEY_HIDEQUICKSLOT(C_MENU_ITEM_DEF)
{
	text[0] = "Ukryj Quickslot";
	...
	onselaction_s[0] = "RUN MENU_ITEM_INP_HIDEQUICKSLOT";
	fontname = MENU_FONT_SMALL;
	flags = flags;
};


instance MENU_ITEM_INP_HIDEQUICKSLOT(C_MENU_ITEM_DEF)
{
	...
	onchgsetoption = "keyHideQuickSlot";
