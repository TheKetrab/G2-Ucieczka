...
func void DIA_NASZ_027_Ghorim_Lojalnosc_Info ()
{
	...
	AI_Output			(other, self, "DIA_NASZ_027_Ghorim_Lojalnosc_15_03"); //Spokojnie, Ghorimie. Myœlê, ¿e móg³byœ wzi¹æ sobie przerwê i odpocz¹æ nieco od pracy. Ka¿demu przecie¿ nale¿y siê wypoczynek i wytchnienie.
	...
	// TODO: bogu Log -> if npc knows info DIA_NASZ_027_Ghorim_Lojalnosc and has items -> Log Entry:
...
//TODO:
func void PierscienLog()
{
	if(Npc_HasItems(hero,ItNa_Pierscien_Zarazy)>=1)
	{
		B_LogEntry (TOPIC_Lojalnosc,"Pierœcieñ faktycznie emanuje magiczn¹ aur¹, zaskakuj¹ce. Sadzê, i¿ warto zabraæ go ze sob¹. Kto wie, czy kiedyœ mi siê nie przyda.");
		ff_remove(PierscienLog);
	};
