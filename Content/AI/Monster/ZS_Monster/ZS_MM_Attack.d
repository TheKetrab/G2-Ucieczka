...
{	
	...
	// ------ ATTACK ------	
		if (Hlp_GetInstanceID(self) == Hlp_GetInstanceID(GroznyZebaczWarta1)) // Nur NSCs angreifen, die NICHT im Talk sind
		{
			...
			AI_Attack (self);		 			//In der Funktion, in der AI_Attack aufgerufen wird DARF KEIN AI_ Befehl VOR AI_Attack kommen, da sonst AI_Attack ignoriert wird
				return LOOP_CONTINUE;								//(AI-Attack funktioniert NUR, wenn die AIqueue leer ist!)
		};
