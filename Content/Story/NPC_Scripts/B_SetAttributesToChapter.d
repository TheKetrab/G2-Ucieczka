...
func void B_SetAttributesToChapter(var C_Npc slf,var int kap)
{
	...
	if(kap == 1)
	{
		...
		slf.aivar[REAL_STRENGTH] = 25;
		slf.attribute[ATR_DEXTERITY] = 25;
		slf.aivar[REAL_DEXTERITY] = 25;
		slf.attribute[ATR_MANA_MAX] = 1000;
		slf.aivar[REAL_MANA_MAX] = 1000;
		slf.attribute[ATR_MANA] = 1000;
	...
	if(kap == 2)
	{
		...
		slf.aivar[REAL_STRENGTH] = 40;
		slf.attribute[ATR_DEXTERITY] = 40;
		slf.aivar[REAL_DEXTERITY] = 40;
		slf.attribute[ATR_MANA_MAX] = 1000;
		slf.aivar[REAL_MANA_MAX] = 1000;
		slf.attribute[ATR_MANA] = 1000;
	...
	{
		slf.level = 30;
		slf.attribute[ATR_STRENGTH] = 55;
		slf.aivar[REAL_STRENGTH] = 55;
		slf.attribute[ATR_DEXTERITY] = 55;
		slf.aivar[REAL_DEXTERITY] = 55;
		slf.attribute[ATR_MANA_MAX] = 1000;
		slf.aivar[REAL_MANA_MAX] = 1000;
		slf.attribute[ATR_MANA] = 1000;
	...
	{
		slf.level = 50;
		slf.attribute[ATR_STRENGTH] = 85;
		slf.aivar[REAL_STRENGTH] = 85;
		slf.attribute[ATR_DEXTERITY] = 85;
		slf.aivar[REAL_DEXTERITY] = 85;
		slf.attribute[ATR_MANA_MAX] = 1000;
		slf.aivar[REAL_MANA_MAX] = 1000;
		slf.attribute[ATR_MANA] = 1000;
